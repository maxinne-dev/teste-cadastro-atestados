...
export function ApiTags(..._args: any[]): ClassDecorator {
  return () => {};
}
// eslint-disable-next-line @typescript-eslint/no-unused-vars
export function ApiBearerAuth(..._args: any[]): any {
  return () => {};
}
// eslint-disable-next-line @typescript-eslint/no-unused-vars
export function ApiBody(..._args: any[]): any {
  return () => {};
}
// eslint-disable-next-line @typescript-eslint/no-unused-vars
export function ApiProperty(..._args: any[]): any {
  return () => {};
}
// eslint-disable-next-line @typescript-eslint/no-unused-vars
export function ApiPropertyOptional(..._args: any[]): any {
  return () => {};
}
