    ...
    <ul class="nav-list">
      ...
      <li>
        <RouterLink
          ...
          class="nav-item"
          :class="{ active: isActive('/collaborators') }"
          @click="$emit('navigate', '/collaborators')"
        >
          <i class="pi pi-users" />
      ...
      <li>
        <RouterLink
          ...
          @click="$emit('navigate', '/certificates')"
        >
      ...
      <li>
        <RouterLink
          ...
          class="nav-item"
          :class="{ active: isActive('/certificates/new') }"
          @click="$emit('navigate', '/certificates/new')"
        >
